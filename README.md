...
- [zsh](https://en.wikipedia.org/wiki/Z_shell) with [Starship](https://starship.rs/)
- [tmux](https://github.com/tmux/tmux/wiki) with [sesh](https://github.com/joshmedeski/sesh)
- [Neovim](https://neovim.io/) ([custom config](.config/nvim/) started from [kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim))
- [lazygit](https://github.com/jesseduffield/lazygit)
- [OpenCode](https://opencode.ai/)

## Machine Setup

- [New Machine Setup](NEW_MACHINE_SETUP.md)
